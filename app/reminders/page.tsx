...
export default function RemindersPage() {
  ...
  return (
    <div className="p-6 md:p-10 max-w-4xl mx-auto space-y-8 bg-gray-50/10 min-h-screen">
      {/* Page Header */}
      <div>
        <span className="text-xs font-semibold text-blue-600 dark:text-blue-400 tracking-wider uppercase">Habit Scheduler</span>
        <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight mt-1">Notification Reminders</h1>
        <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Configure daily alarms and intervals to help you stay on track.</p>
      </div>

      {/* Reminder Config Cards */}
      <div className="grid grid-cols-1 gap-6">
        {/* Water Reminder Card */}
        <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-3xl p-6 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="flex gap-4 items-start">
            <div className="w-12 h-12 bg-indigo-50/50 dark:bg-indigo-950/40 border border-indigo-100/30 dark:border-indigo-900/40 text-indigo-500 rounded-2xl flex items-center justify-center flex-shrink-0">
              <Droplet className="w-6 h-6" />
            </div>
            <div>
              <div className="flex flex-wrap items-center gap-2">
                <h3 className="font-bold text-gray-800 dark:text-white text-base">Water Intake Reminders</h3>
                <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full uppercase ${
                  waterRem?.enabled ? "text-green-600 dark:text-green-400 bg-green-50/50 dark:bg-green-950/40" : "text-gray-400 dark:text-gray-500 bg-gray-50/50 dark:bg-slate-800"
                }`}>
                  {waterRem?.enabled ? "Enabled" : "Disabled"}
                </span>
                {waterRem?.enabled && (
                  <span className="text-[10px] font-extrabold text-blue-600 dark:text-blue-400 bg-blue-50/60 dark:bg-blue-950/50 px-2 py-0.5 rounded-full flex items-center gap-1 border border-blue-100/50 dark:border-blue-900/50 animate-pulse">
              ...
              <div className="flex items-center gap-2 mt-4">
                ...
                <select
                  ...
                  className="px-3 py-1.5 border border-gray-200 dark:border-slate-700 rounded-xl text-xs bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:ring-1 focus:ring-blue-500"
                >
          ...
          <div className="flex gap-3 w-full md:w-auto justify-end border-t border-gray-100 dark:border-slate-800 md:border-none pt-4 md:pt-0">
            <button
              onClick={() => {
                if (waterRem) {
              ...
              className={`px-4 py-2 text-xs font-semibold rounded-xl transition-all border ${
                waterRem?.enabled 
                  ? "bg-gray-50 dark:bg-slate-800 border-gray-200 dark:border-slate-700 text-gray-650 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-700" 
                  : "bg-blue-50 dark:bg-blue-950/40 border-blue-100/50 dark:border-blue-900/50 text-blue-600 dark:text-blue-400 hover:bg-blue-100/50"
              }`}
            >
        ...
        <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-3xl p-6 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="flex gap-4 items-start">
            <div className="w-12 h-12 bg-green-50/50 dark:bg-green-950/40 border border-green-100/30 dark:border-green-900/40 text-green-500 rounded-2xl flex items-center justify-center flex-shrink-0">
              <Activity className="w-6 h-6" />
            </div>
            <div>
              <div className="flex flex-wrap items-center gap-2">
                <h3 className="font-bold text-gray-800 dark:text-white text-base">Exercise Routine Reminders</h3>
                <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full uppercase ${
                  workoutRem?.enabled ? "text-green-600 dark:text-green-400 bg-green-50/50 dark:bg-green-950/40" : "text-gray-400 dark:text-gray-500 bg-gray-50/50 dark:bg-slate-800"
                }`}>
                  {workoutRem?.enabled ? "Enabled" : "Disabled"}
                </span>
                {workoutRem?.enabled && (
                  <span className="text-[10px] font-extrabold text-green-650 dark:text-green-400 bg-green-50/60 dark:bg-green-950/50 px-2 py-0.5 rounded-full flex items-center gap-1 border border-green-100/50 dark:border-green-900/50 animate-pulse">
        ...
        <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-3xl p-6 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="flex gap-4 items-start">
            <div className="w-12 h-12 bg-purple-50/50 dark:bg-purple-950/40 border border-purple-100/30 dark:border-purple-900/40 text-purple-500 rounded-2xl flex items-center justify-center flex-shrink-0">
              <Moon className="w-6 h-6" />
            </div>
            <div>
              <div className="flex flex-wrap items-center gap-2">
                <h3 className="font-bold text-gray-800 dark:text-white text-base">Bedtime Reminders</h3>
                <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full uppercase ${
                  sleepRem?.enabled ? "text-green-600 dark:text-green-400 bg-green-50/50 dark:bg-green-950/40" : "text-gray-400 dark:text-gray-500 bg-gray-50/50 dark:bg-slate-800"
                }`}>
                  {sleepRem?.enabled ? "Enabled" : "Disabled"}
                </span>
                {sleepRem?.enabled && (
                  <span className="text-[10px] font-extrabold text-purple-600 dark:text-purple-400 bg-purple-50/60 dark:bg-purple-950/50 px-2 py-0.5 rounded-full flex items-center gap-1 border border-purple-100/50 dark:border-purple-900/50 animate-pulse">
              ...
              <div className="flex items-center gap-2 mt-4">
                <span className="text-xs text-gray-500 dark:text-gray-400">Bedtime:</span>
                <input
                  type="time"
                  value={sleepTime}
